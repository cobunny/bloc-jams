...
var albumPicasso = {
    ...
    songs: [
        { name: 'Blue', length: '4:26',  audioUrl: 'styles/assets/music/blue'},
        { name: 'Green', length: '3:14', audioUrl: 'styles/assets/music/green'},
        { name: 'Red', length: '5:01', audioUrl: 'styles/assets/music/red'},
        { name: 'Pink', length: '3:21', audioUrl: 'styles/assets/music/pink'},
        { name: 'Magenta', length: '2:15', audioUrl: 'styles/assets/music/magenta'}
    ]
};
